...
func (handler *Handler) SearchSongs(songName string, genre string) []models.Song {
	var songs []models.Song
	handler.DB.Preload("Genres").Where("LOWER(name) LIKE ?", "%"+strings.ToLower(songName)+"%").Find(&songs)
	return songs
}
