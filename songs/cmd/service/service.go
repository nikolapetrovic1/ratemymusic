...
import (
	...
	http "github.com/nikolapetrovic1/ratemymusic/songs/pkg/http"
...
var fs = flag.NewFlagSet("songs", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		// recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "songs")
