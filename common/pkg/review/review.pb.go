...
var file_pkg_review_review_proto_rawDesc = []byte{
	...
	0x10, 0x01, 0x32, 0xff, 0x02, 0x0a, 0x0d, 0x52, 0x65, 0x76, 0x69, 0x65, 0x77, 0x53, 0x65, 0x72,
	...
	0x74, 0x61, 0x22, 0x00, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x62,
...
var file_pkg_review_review_proto_depIdxs = []int32{
	...
	1, // 7: review.ReviewService.FindByUser:output_type -> review.ReviewResponse
	1, // 8: review.ReviewService.FindBySong:output_type -> review.ReviewResponse
	1, // 9: review.ReviewService.FindByAlbum:output_type -> review.ReviewResponse
	2, // 10: review.ReviewService.FindByUserSong:output_type -> review.ReviewData
	2, // 11: review.ReviewService.FindByUserAlbum:output_type -> review.ReviewData
	2, // 12: review.ReviewService.CreateReview:output_type -> review.ReviewData
